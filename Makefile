...
OBJS = numOp.o Invalid.o Timer.o FileOp.o Distribution.o IntTypes.o FloatTypes.o ArrayTypes.o FarrayTypes.o SarrayTypes.o Perm.o String.o chStringTypes.o spString.o IntervalTypes.o MatrixTypes.o FmatrixTypes.o TreeTypes.o DenseGraph.o GraphTypes.o DigraphTypes.o Coordinates.o Polynomial.o Tuple.o ParamArray.o lSumInt.o Generator.o main.o
HEADER2 = numOp.h Invalid.h Timer.h FileOp.h Distribution.h IntTypes.h FloatTypes.h ArrayTypes.h FarrayTypes.h SarrayTypes.h Perm.h String.h chStringTypes.h spString.h IntervalTypes.h MatrixTypes.h FmatrixTypes.h TreeTypes.h DenseGraph.h GraphTypes.h DigraphTypes.h Coordinates.h Polynomial.h Tuple.h ParamArray.h lSumInt.h Generator.h
...
lSumInt.o : $(HEADER1) lSumInt.h
	$(CXX) $(CXXFLAGS) -c lSumInt.cpp
